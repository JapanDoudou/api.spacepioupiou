...
class App_KernelDevDebugContainer extends Container
{
    ...
    /**
     * Gets the private 'annotated_app_entity_scores_api_platform_core_bridge_doctrine_orm_filter_range_filter' shared autowired service.
     *
     * @return \ApiPlatform\Core\Bridge\Doctrine\Orm\Filter\RangeFilter
     */
    protected function getAnnotatedAppEntityScoresApiPlatformCoreBridgeDoctrineOrmFilterRangeFilterService()
    {
        ...
        return $this->privates['annotated_app_entity_scores_api_platform_core_bridge_doctrine_orm_filter_range_filter'] = new \ApiPlatform\Core\Bridge\Doctrine\Orm\Filter\RangeFilter(($this->services['doctrine'] ?? $this->getDoctrineService()), NULL, ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())), ['score' => 'DESC'], ($this->privates['serializer.name_converter.metadata_aware'] ?? $this->getSerializer_NameConverter_MetadataAwareService()));
    }
    ...
    protected function getApiPlatform_FilterLocatorService()
    {
        return $this->privates['api_platform.filter_locator'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'annotated_app_entity_scores_api_platform_core_bridge_doctrine_orm_filter_range_filter' => ['privates', 'annotated_app_entity_scores_api_platform_core_bridge_doctrine_orm_filter_range_filter', 'getAnnotatedAppEntityScoresApiPlatformCoreBridgeDoctrineOrmFilterRangeFilterService', false],
            ...
            'annotated_app_entity_scores_api_platform_core_bridge_doctrine_orm_filter_range_filter' => '?',
